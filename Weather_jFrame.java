 ...
 * @author P0068839
 */
public class Weather_jFrame extends javax.swing.JFrame {

    /**
     * Creates new form AnotherSeparateJFrame
     */
    public Weather_jFrame() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String theAppid = "&appid=adfasdfafasdfa";
        ...
        // Get the lat & long for the city name.
        
        stringURL = "http://api.openweathermap.org/geo/1.0/direct?&mode=json";
        stringURL += theCity;
        stringURL += theAppid;
	...
	*/
	...
	byte[] theData = new byte[2000]; // Make this byte array comfortably large
	try {
		...
		System.out.println("\n\n");
		*/
		// Look for the "lon" and "lat" tags and grab their values!
		String strData = new String(theData);
		System.out.println(strData);
                
                
 		int posLon = strData.indexOf("\"name\"");
                System.out.println("posLon is " + Integer.toString(posLon));
		int pos = posLon + 8;
		int p = 0;
		byte[] lonlon = new byte[20]; // Make this byte array comfortably large
		while (theData[pos] != '"') {
			lonlon[p] = theData[pos];
                        System.out.println("lonlon[p] is " + lonlon[p]);
			pos++;
			p++;
		}

                
                System.out.println("lonlon is " + lonlon);
		theLon = new String(lonlon);
                System.out.println("theLon is " + theLon);
		//double dLonLon = Double.parseDouble(theLon);
        ...
        // Now use the lat & long to get the weather for that city!
        		
	//String stringURL = "https://api.openweathermap.org/data/2.5/weather?units=metric&mode=json";
        stringURL = "https://api.openweathermap.org/data/2.5/weather?lat=43.5853&lon=-79.6450&units=metric&mode=json";	
	stringURL += theAppid;
	...
	respMsg = "This is my bogus response message!";
	try {
		respMsg = connection.getResponseMessage();
		//System.out.println("respMsg is " + respMsg);
	...
	*/
	...
	theData = new byte[1000]; // Make this byte array comfortably large
	try {
		int numBytesRead = responseStream.read(theData);
		/*
		System.out.println("\n\nnumBytesRead is " + numBytesRead);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Weather_jFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Weather_jFrame().setVisible(true);
            }
        });
    }
